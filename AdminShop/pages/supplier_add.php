          ...
          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    <label for="supp_name">Brand Name:</label>
                    <input type="text" class="form-control" id="supp_name" name="supp_name" placeholder="Supplier Name"/>
                    <label for="supp_address">Country:</label>
                    <input type="text" class="form-control" id="supp_address" name="Country" placeholder="Country"/>
                    <label for="supp_contact">Technology</label>
                    <input type="text" class="form-control" id="supp_contact" name="tech" placeholder=" "/>
                    <label for="supp_email">Other</label>
                    <input type="text" class="form-control" id="supp_email" name="supp_email" placeholder="remark"/>
                </div>
                <br>

                <div class="form group">
                    <button type="submit" class="btn btn-success btn-round" id="submit" name="submit">
                    <i class="now-ui-icons ui-1_check"></i> Update Brand Sup
                    </button> 
                </div>
            </form>
          </div>
