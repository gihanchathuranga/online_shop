...
<br>
  ...
  <div class="panel-heading"><h3>Update Brand</h3></div>
        ...
        <div class="form group">
            ...
            <div class="form group">
                <button type="submit" class="btn btn-success btn-round" id="submit" name="update">
                    <i class="now-ui-icons ui-1_check"></i> Update Brand
                </button>
            </div>
    </form>
  </div>
