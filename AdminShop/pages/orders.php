...
<?php
                                      ...
                                      $query = "SELECT * FROM transactions LEFT JOIN users ON users.user_id = transactions.user_id";
                                      $result = mysqli_query($dbconn,$query);
                                      ?>  
                                 
                                <br>
                                <br>
                                <table id="" class="table table-success table-hover">
                                    <tr>
                                        ...
                                        <?php
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              ...
                                              echo " <td><a href='adminAccept.php '><button class='btn btn-warning btn-round' type='button' name='accept'>update qty</button></a></td>" ;                                               
                                           // echo " <a href='adminAccept.php '>update qty</a>" ;     
                                              echo "</tr>";
                                            }
                                          }?>
                                </table><br><br><br><br>
