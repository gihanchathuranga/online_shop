...
if ($message && $nickname) {
    ...
    $data = "<h6  style='color:white';>[" . $date . "] <b>" . $nickname . ":</b> " . $_POST['message'] . "</h6>";
            ...
            <nav>
                <h2 align="center" style="color:red">Online Chat Room</h2>
                         ...
                         <form id="send-message-form" action="" method="post">
                           ...
                           <input class="form-control  " name="nickname" placeholder="nickname..." style="color:yellowgreen"readonly value="<?php echo $_SESSION['namesSession'] ?> " />   
                         </div>
