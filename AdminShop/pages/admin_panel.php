...
<body class="profile-page sidebar-collapse">
    ...
    <!-- End Navbar -->
                    ...
                    <div class="content-center">
                        <div class="photo-container">
                           <!-- <img src="../assets/img/default-avatar.png" alt="">-->
                            <img src="../uploads/<?php echo $res['image']; ?>" width="200px" height="200px">
        ...
        <div class="section"  style="background-color:beige">
            <div class="container">
                    ...
                    <div class="col-md-6 ml-auto mr-auto">
                        ...
                        <div class="nav-align-center">
                            <ul class="nav nav-pills nav-pills-primary" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#userlog" role="tablist"rel="tooltip" title="Click To View The User Logs " data-placement="bottom">
                                        <i class="now-ui-icons ui-1_email-85"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#adminlog" role="tablist"rel="tooltip" title="Click To View The Admin Logs" data-placement="bottom">
                                        <i class="now-ui-icons loader_refresh"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#products" role="tablist"rel="tooltip" title="Click To Add Product" data-placement="bottom">
                                        <i class="now-ui-icons shopping_tag-content"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    
                                    <a class="nav-link" data-toggle="tab" href="#supplier" role="tablist" rel="tooltip" title="Click To Add Brand" data-placement="bottom">
                                        <i class="now-ui-icons tech_mobile"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#user_accounts" role="tablist" rel="tooltip" title="Click To Manage User Account" data-placement="bottom">
                                        <i class="now-ui-icons users_circle-08"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#admin_accounts" role="tablist"rel="tooltip" title="Click To Manage Admin Account" data-placement="bottom">
                                ...
                                <div class="row collections">
                                      ...
                                      <br><br>
                                        <table id="" class="table table-active table-hover">
                                          <thead>
                                            <tr>
                                              <th align="center">--------------------Start of Log--------------------</th>
                                            </tr>
                                          </thead>
                                            <?php
